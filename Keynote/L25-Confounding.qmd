...
```{r label='460-ConfoundingdqOoXV', message=FALSE}
# overall cancer rate
Cancer_data |> 
...
```{r label='460-Confounding-89iTb3'}
mod |> conf_interval()
```
...
```{r label='460-ConfoundingU31A4m', digits=3, message = FALSE}
Cancer_data |>
  mutate(illness = zero_one(illness, one="cancer")) |>
