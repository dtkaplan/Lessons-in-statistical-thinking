...
The statistical thinker seeks to identify patterns in data, such as possible relationships between variables. Translating a data frame into graphical form---data graphics---is essential for revealing or suggesting patterns.  
...
```{r echo=FALSE}
GDAdata::EastIndiesTrade |> head(9) 
```
