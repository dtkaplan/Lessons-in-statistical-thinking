...
Births2022 |> point_plot(duration ~ 1,
                        point_ink = 0.1, size = 0.2, jitter="y")       # details
Births2022 |> point_plot(duration ~ 1, annot="violin",
                        point_ink = 0.1, size = 0.2, bw=0.5, jitter="y") # details
```
...
ggplot(patch_points, aes(x=x, y=y)) +
  geom_point(size=0.1, point_ink = 0.5) +
  coord_fixed() +
  theme_void()
```
...
#| layout-ncol: 2
Monocacy_river |> point_plot(precip ~ 1, annot="violin")
US_wildfires |> point_plot(area ~ 1, annot="violin")
```
...
`r this_exercise(ID="Q03-101")`
{{< include ../LSTexercises/03-Variation/Q03-101.Rmd >}}
:::

::: {.callout-note collapse="true"}
`r this_exercise(ID="cheetah-hit-plate")`
{{< include ../LSTexercises/fromSDS/cheetah-hit-plate.Rmd >}}
:::

::: {.callout-note collapse="true"}
`r this_exercise(ID="Q03-102")`
{{< include ../LSTexercises/03-Variation/Q03-102.Rmd >}}
:::

::: {.callout-note collapse="true"}
`r this_exercise(ID="Q03-103")`
{{< include ../LSTexercises/03-Variation/Q03-103.Rmd >}}
:::

::: {.callout-note collapse="true"}
`r this_exercise(ID="Q03-104")`
{{< include ../LSTexercises/03-Variation/Q03-104.Rmd >}}
:::
 ::: {.callout-note collapse="true"}
`r this_exercise(ID="Q03-105")`
{{< include ../LSTexercises/03-Variation/Q03-105.Rmd >}}
:::
