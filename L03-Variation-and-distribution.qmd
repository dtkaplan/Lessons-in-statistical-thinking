...
::: {#exr-03-901}
Go back to the Enrichment topic of Lesson 2 and remake the plot choosing a few different values of duration and mapping plurality to x, while adding violins.
:::
