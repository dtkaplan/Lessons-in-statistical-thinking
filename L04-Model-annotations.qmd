...
Joined <- bind_cols(sample(Tmp), sample(Tmp2))
Joined_small <- sample(Joined, n=nsegs) |> 
...
`r exercise_id("Q04-100")`
:::

-----

::: {#exr-Q04-103}
{{< include ../LSTexercises/04-Model-annotations/Q04-103.Rmd >}}

`r exercise_id("Q04-103")`
:::
