...
```{r echo=FALSE, digits=2, and_so_on = "... and so on for 100 observations altogether", results=asis()}
set.seed(101)
The_observations <- datasim_make(interval <- rexp(n, rate = 1/85)) |>take_sample(n=250)
...
emit_exercise_markup(
  paste0("../LSTexercises/16-Adjustment/",
         c("Q16-101.Rmd",
           "Q16-201.Rmd",
           "Q16-202.Rmd")),
