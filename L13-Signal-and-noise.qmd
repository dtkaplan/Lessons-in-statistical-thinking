...
```{r label='320-Signal-and-noise-swEwZq', digits=3}
...
```{r label='320-Signal-and-noise-oH2Dfx', digits = 3}
With_signal |>
...
```{r label='320-Signal-and-noise-gmmy0x', digits=2}
With_signal |>
...
```{r label='320-Signal-and-noise-KQ81eu', digits=3}
Penguins |>
