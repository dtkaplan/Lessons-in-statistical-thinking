...
```{r echo=FALSE}
Penguins |>
  point_plot(bill_length ~ sex, annot = "model", 
             point_ink = 0.2, model_ink=0.8)
Penguins |>
  point_plot(bill_length ~ mass, annot= "model", point_ink = 0.2)
```
...
`r gdef("Prior probability")`

`r gdef("Posterior probability")`
...
`r gdef("credibility, credence, belief, faith, credit, credulity, confidence, certitude, etc.", "belief")`
...
`r gdef("Null hypothesis testing")`
...
`r gdef("NP")`, short for the "Neyman-Pearson" approach.
