...
```{r echo=FALSE}
#| label: fig-water-immersion
#| fig-cap: "Diagram of the apparatus for measuring body volume. The inset shows a secondary apparatus for measuring the air remaining in the lungs after the subject has breathed out as far as practicable. [Source: Durnin and Rahama (1967) *British Journal of Nutrition* **21**: 681](https://www.cambridge.org/core/services/aop-cambridge-core/content/view/DA80501B784742B9B2F4F454BDEE923B/S0007114567000728a.pdf/the-assessment-of-the-amount-of-fat-in-the-human-body-from-measurements-of-skinfold-thickness.pdf)"
#| column: margin
knitr::include_graphics("www/body-density-measurement.png")
```
...
#| column: margin
set.seed(134)
Whickham |> sample(n = 5)  |> tibble::remove_rownames() |> 
  select(age, smoker, outcome) |> knitr::kable()
```
