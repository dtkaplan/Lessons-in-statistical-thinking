...
For demonstration purposes, these Lessons make available a random `r gdef("*sample*")` of size 20,000 of the CDC public-use file. The data frame containing the sample is named `Births2022`. 
:::
